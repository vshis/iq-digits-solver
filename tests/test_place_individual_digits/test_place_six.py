...
def test_place_six_up(setup_game_state: dict):
...
def test_place_six_down(setup_game_state: dict):
...
def test_place_six_left(setup_game_state: dict):
...
def test_place_six_right(setup_game_state: dict):
