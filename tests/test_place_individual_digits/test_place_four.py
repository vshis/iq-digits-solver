...
def test_place_four_up(setup_game_state: dict):
...
def test_place_four_down(setup_game_state: dict):
...
def test_place_four_left(setup_game_state: dict):
...
def test_place_four_right(setup_game_state: dict):
