...
def test_place_nine_up(setup_game_state: dict):
...
def test_place_nine_down(setup_game_state: dict):
...
def test_place_nine_left(setup_game_state: dict):
...
def test_place_nine_right(setup_game_state: dict):
