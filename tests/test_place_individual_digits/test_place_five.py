...
def test_place_five_up(setup_game_state: dict):
...
def test_place_five_down(setup_game_state: dict):
...
def test_place_five_left(setup_game_state: dict):
...
def test_place_five_right(setup_game_state: dict):
