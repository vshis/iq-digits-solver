...
def test_place_seven_up(setup_game_state: dict):
...
def test_place_seven_down(setup_game_state: dict):
...
def test_place_seven_left(setup_game_state: dict):
...
def test_place_seven_right(setup_game_state: dict):
