...
def test_place_eight_up(setup_game_state: dict):
...
def test_place_eight_down(setup_game_state: dict):
...
def test_place_eight_left(setup_game_state: dict):
...
def test_place_eight_right(setup_game_state: dict):
